...
class NoteRepository:
    ...
    def find_by_id(self, note_id_to_find, username):
        ...
        for i in range(1, n + 1):
            ...
            app.logger.debug(note.allowed_users)

            if note.id == note_id_to_find and (
                    username in note.allowed_users or ALL_USERS in note.allowed_users or username == note.username):
                return note
        return None
